...
#[derive(Debug)]
pub struct NodeRangerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodeRangerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodeRanger processing");
    
    let mut processor = NodeRangerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodeRangerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodeRangerProcessor::new(false);
